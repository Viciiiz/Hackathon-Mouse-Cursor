/**
 * Read data from the gy-521 board. The program will return the X rotation, the Y rotation, a boolean for clicking flag, and a boolean for control flag.
 */
...
void loop() {
  ...
  Serial.print(" | aY = "); 
  Serial.println(convert_int16_to_str(y));
